        ...
        <div style={{ width: "100%", maxWidth: 400 }}>
          ...
          <div style={{
            ...
            <form onSubmit={handleRegister} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <div>
                <label style={{ display: "block", marginBottom: 6, fontSize: "0.75rem", fontWeight: 600, color: "#71717A", letterSpacing: "0.04em" }}>
                  PASSWORD <span style={{ color: "#3F3F46", fontWeight: 400 }}>— min. 6 characters</span>
                </label>
                <div style={{ position: "relative" }}>
                  <input
                    id="register-password" type={showPassword ? "text" : "password"} required minLength={6}
            ...
            <p style={{ textAlign: "center", marginTop: 20, fontSize: "0.75rem", color: "#3F3F46", lineHeight: 1.6 }}>
              By signing up you agree to track your own bank data responsibly.
            </p>
          </div>
